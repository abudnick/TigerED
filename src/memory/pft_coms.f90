...
module pft_coms
   ...
   ! 17 - Araucaria                                                                        !
   ! 18 - early successional light deciduous broadleaf evergreen
   ! 19 - mid successional light deciduous broadleaf evergreen
   ! 20 - late successional light deciduous broadleaf evergreen
   !------+-------------------------------------+---------+----------+---------------------!
   ...
   !---- Carbon to Phosphorus ratio, Balive
   real, dimension(n_pft) :: c2p_alive
   !---- Carbon to Phosphorus ratio, Bdead
   real, dimension(n_pft) :: c2p_dead
   !---- Carbon to Phosphorus ratio, Bstorage
   real, dimension(n_pft) :: c2p_storage
   !---- Carbon to Phosphorus ratio, recruits
   real, dimension(n_pft) :: c2p_recruit
