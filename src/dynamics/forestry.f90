...
subroutine norm_harv_patch(csite,newp)
   ...
   csite%fsp_in(newp)                      = csite%fsp_in(newp)              * area_fac
   csite%stsp_in(newp)                      = csite%stsp_in(newp)              * area_fac


   csite%total_plant_nitrogen_uptake(newp) = csite%total_plant_nitrogen_uptake(newp)       &
                                           * area_fac
   csite%total_plant_P_uptake(newp) = csite%total_plant_P_uptake(newp)       &
                                           * area_fac
