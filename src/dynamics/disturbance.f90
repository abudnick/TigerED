...
module disturbance_utils
   ...
   subroutine apply_disturbances(cgrid)
     use phenology_startup, only: initialize_paw
      ...
      real :: plantP1, soilP1, totalP1, plantP2, soilP2,totalP2
...
plantP1=0.;plantP2=0.;soilP1=0.;soilP2=0.;totalP1=0.;totalP2=0.
...
!stop
   ...
   subroutine initialize_disturbed_patch(csite,atm_tmp,np,dp,lsl)
      ...
      csite%fsp_in                     (np) = 0.0
      csite%stsp_in                     (np) = 0.0

      csite%total_plant_nitrogen_uptake(np) = 0.0
      csite%total_plant_P_uptake(np) = 0.0
      !------------------------------------------------------------------------------------!
   ...
   subroutine increment_patch_vars(csite,np, cp, area_fac)
      ...
      csite%fsp_in                     (np) = csite%fsp_in                     (np)        &
                                            + csite%fsp_in                     (cp)        &
                                            * area_fac
      csite%stsp_in                     (np) = csite%stsp_in                     (np)        &
                                            + csite%stsp_in                     (cp)        &
                                            * area_fac
      ...
      csite%total_plant_P_uptake(np) = csite%total_plant_P_uptake(np)        &
                                            + csite%total_plant_P_uptake(cp)        &
                                            * area_fac
